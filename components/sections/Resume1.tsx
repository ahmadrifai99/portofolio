					...
					<div className="row mt-6">
									...
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												...
												<p className="text-300 mb-0">Universitas Mercu Buana</p>
											</div>
											<h3 className="text-linear-1 ms-auto fw-semibold">3.49<span className="fs-4 fw-bold">/4.00</span></h3>
										</div>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<div className="d-flex align-items-end">
											<div>
												<p className="fw-extra-bold text-linear-1 mb-2">2023</p>
						...
						<div className="col-lg-6 col-12">
							<div className="resume-card p-lg-6 p-4 h-100">
								...
								<div className="resume-card-body">
									<div className="resume-card-item px-4 py-3 mt-5">
										<p className="fw-extra-bold text-linear-1 mb-2">2023 - 2025</p>
										<h5>FullStack Developer & QA Engineer (Automation)</h5>
										<p className="text-300 mb-0">PT Indosistem Teknologi Utama</p>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<p className="fw-extra-bold text-linear-1 mb-2">2021 - 2021</p>
										<h5>Internship - Web Developer </h5>
										<p className="text-300 mb-0">PT Ardilia Nugraha Safetya</p>
									</div>
									<div className="resume-card-item px-4 py-3 mt-5">
										<p className="fw-extra-bold text-linear-1 mb-2">2018</p>
										<h5>Freelance</h5>
										<p className="text-300 mb-0">Self-Employed</p>
									</div>
									<div className="resume-card-item px-4 py-3 mt-4">
										<p className="fw-extra-bold text-linear-1 mb-2">2017</p>
										<h5>Internship - IT Support</h5>
										<p className="text-300 mb-0">Lemigas</p>
									</div>
								</div>
							</div>
						</div>
