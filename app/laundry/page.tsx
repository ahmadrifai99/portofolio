...
export default function LaundryProject() {
					...
					<section className="section-work-single section-padding">
						<div className="container">
							<div className="row">
								...
								<img src="/assets/imgs/work/laundry.png" alt="" />
								<div className="col-lg-8 mx-lg-auto mt-8">
									<h5 className="fs-5 fw-medium">Description</h5>
									<p className="text-300">
                                        A modern web-based laundry service platform designed to simplify the ordering, tracking, and management of laundry services for customers. The project focused on building a responsive and intuitive frontend that enhances user interaction, supports real-time service updates, and provides a seamless booking experience. The primary goal was to improve service accessibility, increase operational transparency, and deliver a user-friendly digital experience for both customers and staff.									</p>
									<h5 className="fs-5 fw-medium mt-4">Key Features</h5>
									<ul>
										<li>
											<p className="text-gray fw-bold">User-Friendly Booking System: <span className="text-300 fw-medium">Developed an easy-to-use interface that allows customers to schedule pickups and deliveries with just a few clicks, ensuring a smooth onboarding and ordering process.</span></p>
										</li>
										{/* <li>
											<p className="text-gray fw-bold">Real-Time Order Tracking: <span className="text-300 fw-medium">Implemented fully integrated modules including Accounting, Inventory Management, Procurement, Sales, and Human Resources to support daily business operations.</span></p>
										</li>
										<li>
									...
									<ul>
										<li>
											<p className="text-gray fw-bold">Front-End: <span className="text-300 fw-medium">Next JS</span></p>
										</li>
										{/* <li>
